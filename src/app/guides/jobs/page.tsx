...
const plannedPage = {
  "route": "/guides/jobs",
  "title": "Brookhaven RP Jobs",
  "description": "Find the current Brookhaven RP details for brookhaven jobs, including what to do next and related pages.",
  "eyebrow": "Guide",
  "primaryKeyword": "brookhaven jobs",
  "keywords": [
    "brookhaven jobs",
    "how to get a job in brookhaven",
    "brookhaven roleplay jobs"
  ],
  "parentHub": "/guides",
  "internalLinks": [
    {
