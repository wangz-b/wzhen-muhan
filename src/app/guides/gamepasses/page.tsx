...
const plannedPage = {
  "route": "/guides/gamepasses",
  "title": "Brookhaven RP Gamepasses",
  "description": "Find the current Brookhaven RP details for brookhaven best gamepasses, including what to do next and related pages.",
  "eyebrow": "Comparison Guide",
  "primaryKeyword": "brookhaven best gamepasses",
  "keywords": [
    "brookhaven best gamepasses",
    "brookhaven gamepasses worth it"
  ],
  "parentHub": "/guides",
  "internalLinks": [
    {
