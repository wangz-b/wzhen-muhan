...
const plannedPage = {
  "route": "/guides/private-server",
  "title": "Brookhaven RP Private Server",
  "description": "Find the current Brookhaven RP details for brookhaven private server commands, including what to do next and related pages.",
  "eyebrow": "Guide With Tool",
  "primaryKeyword": "brookhaven private server commands",
  "keywords": [
    "brookhaven private server commands",
    "brookhaven private server settings"
  ],
  "parentHub": "/guides",
  "internalLinks": [
    {
