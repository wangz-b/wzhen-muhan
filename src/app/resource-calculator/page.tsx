    ...
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <section className="mt-10 grid gap-4 md:grid-cols-3">
        <article className="content-card">
          ...
          <p className="mt-3 text-sm leading-6 text-white/66">Set a clear planning target, compare time and access costs, and treat every estimate as a flexible roleplay-session plan.</p>
        </article>
        <article className="content-card">
