...
export default function TierListPage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      />
      <p className="mt-5 max-w-4xl text-white/70">Compare the best Brookhaven vehicles by role and use case, then continue to houses and gamepasses. This Brookhaven best homes, cars and gamepasses ranking uses visible confidence labels and a checked date because access and player preferences can change.</p>
      <AdsterraArticleTop />
      ...
      <section className="mt-10 grid gap-4 lg:grid-cols-3">
        ...
        <article className="content-card">
          ...
          <p className="mt-2 text-sm leading-6 text-white/66">Rank choices by roleplay usefulness, access, group fit, and how clearly each pick supports a Brookhaven scene.</p>
        </article>
        <article className="content-card">
