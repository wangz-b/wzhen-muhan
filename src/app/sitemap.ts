...
const routes: Array<{
  ...
  { path: "/map", changeFrequency: "weekly", priority: 0.82 },
  { path: "/tools/roleplay-generator", changeFrequency: "weekly", priority: 0.92 },
  ...
  { path: "/wiki/houses", changeFrequency: "weekly", priority: 0.78 },
  { path: "/wiki/vehicles", changeFrequency: "weekly", priority: 0.78 },
  { path: "/guides/gamepasses", changeFrequency: "weekly", priority: 0.78 },
  { path: "/updates/august-28-2026", changeFrequency: "daily", priority: 0.78 },
  { path: "/guides/jobs", changeFrequency: "weekly", priority: 0.78 },
  { path: "/guides/private-server", changeFrequency: "weekly", priority: 0.78 },
];
