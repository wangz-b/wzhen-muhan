...
export const metadata: Metadata = {
  title: `${siteConfig.gameName} Updates, Events and Code Checks`,
  description: `Track ${siteConfig.gameName} updates, events, code refreshes, Roblox changes, and community notes before acting on new information.`,
...
export default function UpdatesPage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro
        eyebrow="Updates"
        title={`${siteConfig.gameName} Updates and Events`}
        description="Use this page for new patches, events, milestone rewards, code refresh checks, and pages that may change after updates."
      />
      <AdsterraArticleTop />
      ...
      <section className="mt-12 grid gap-4 md:grid-cols-3">
        ...
        <article className="content-card">
          ...
          <p className="mt-3 text-sm leading-6 text-white/66">Refresh tier-list and build advice when a patch changes units, items, traits, rewards, or progression speed.</p>
        </article>
        <article className="content-card">
