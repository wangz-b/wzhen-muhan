...
const plannedPage = {
  "route": "/wiki/vehicles",
  "title": "Brookhaven RP Vehicles",
  "description": "Find the current Brookhaven RP details for brookhaven vehicle list, including what to do next and related pages.",
  "eyebrow": "Entity Hub With Filter",
  "primaryKeyword": "brookhaven vehicle list",
  "keywords": [
    "brookhaven vehicle list",
    "how to spawn a car in brookhaven"
  ],
  "parentHub": "/wiki",
  "internalLinks": [
    {
    ...
    },
    {
      "href": "/guides",
      "label": "Guides",
      "description": "Find beginner, farming, and progression help."
    }
  ]
};
