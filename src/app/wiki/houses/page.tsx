...
const plannedPage = {
  "route": "/wiki/houses",
  "title": "Brookhaven RP Houses",
  "description": "Find the current Brookhaven RP details for brookhaven houses, including what to do next and related pages.",
  "eyebrow": "Entity Hub With Filter",
  "primaryKeyword": "brookhaven houses",
  "keywords": [
    "brookhaven houses",
    "brookhaven best houses",
    "brookhaven house finder",
    "how to claim a house in brookhaven",
    "how to save house in brookhaven"
  ],
  "parentHub": "/wiki",
  "internalLinks": [
    {
