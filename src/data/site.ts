...
export const siteConfig: SiteConfig = {
  ...
  navGroups: [
    ...
    },
    {
      ...
      href: "/wiki",
      items: [
        { label: "Wiki Hub", href: "/wiki", description: "Brookhaven houses, vehicles, places, and roleplay facts." },
        { label: "Houses", href: "/wiki/houses", description: "Compare homes and choose a setting for your story." },
        { label: "Vehicles", href: "/wiki/vehicles", description: "Compare vehicles by role, access, and group size." },
        { label: "Map", href: "/map", description: "Find useful Brookhaven locations and story settings." }
      ]
    },
    {
      label: "Tools",
      href: "/tools/roleplay-generator",
      items: [
        { label: "Story Lab", href: "/tools/roleplay-generator", description: "Generate a Brookhaven roleplay setup, cast, twist, and next scene." },
        { label: "House Guide", href: "/wiki/houses", description: "Choose a home that fits your roleplay scenario." },
        { label: "Vehicle Guide", href: "/wiki/vehicles", description: "Choose a vehicle for families, jobs, or emergencies." },
        { label: "Tier List", href: "/tier-list", description: "Compare Brookhaven homes, vehicles, and gamepasses by use case." }
      ]
    },
    {
      label: "Info",
...
export const heroActions = [
  ...
  { href: "/tools/roleplay-generator", label: "Open Story Lab" }
] as const;
...
export const toolCards: LinkCard[] = [
  ...
  },
  {
    ...
    description: "Plan a cast, setting, conflict, and safe next scene for a Brookhaven story."
  },
  {
...
export const wikiCards: LinkCard[] = [
  {
    ...
    eyebrow: "Wiki",
    description: "Compare Brookhaven houses, vehicle access, props, and roleplay uses."
  },
  {
    title: "Maps and systems",
    href: "/wiki/maps-and-systems",
    eyebrow: "Wiki",
    description: "Browse Brookhaven locations, public spaces, homes, and roleplay systems."
  },
  {
    title: "Builds and entities",
    href: "/wiki/builds-and-entities",
    eyebrow: "Wiki",
    description: "Browse roleplay jobs, family roles, emergency scenes, and story ideas."
  }
];
